                        ...
                        <table class="inner-body" align="center" width="570" cellpadding="0" cellspacing="0">
                            ...
                            <tr>
                                <td class="content-cell" style="padding: 35px;">
                                    ...
                                    <p style="margin-bottom: 0;">Pemesanan telah dikonfirmasi. Segera hubungi <b>{{ $user->name }}</b> untuk melanjutkan proses pemesanan.</p>
                                    <p style="margin: 0;">Pembayaran akan dilepaskan setelah <b>{{ $user->name }}</b> memberikan konfirmasi penerimaan.</p>
                                </td>
                            </tr>
                        </table>
                    </td>
