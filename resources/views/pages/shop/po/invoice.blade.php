    ...
    <div class="invoice">
                ...
                <div class="width-50 float-left">
                    <table>
                        <tbody>
                            ...
                            <td>{{ date('j F Y', strtotime(\Illuminate\Support\Carbon::now())) }}</td>
                        </tbody>
                    </table>
                </div>
                <div class="width-50 float-left">
        ...
        <div class="info-item" style="margin-bottom: 10px;">
                    ...
                    <div class="clear table-content">
                        <div class="float-left" style="width: 40%;">
                            <div class="" style="padding: 10px;">
                                ...
                                <p class="m-0"><small>#{{ $item->vendor->name }}</small></p>
                            </div>
                        </div>
                        <div class="float-left text-right" style="width: 10%;">
                            <div class="" style="padding: 10px;">
                                <p class="m-0"><small>{{ $qty[$index] }}</small></p>
                            </div>
                        </div>
                        <div class="float-left text-right" style="width: 25%;">
                            <div class="" style="padding: 10px;">
                                <p class="m-0"><small>Rp. {{ number_format(($item->price_after_discount != '' || $item->price_after_discount != null || $item->price_after_discount != 0) ? $item->price_after_discount : $item->normal_price) }},-</small></p>
                            </div>
                        </div>
                        <div class="float-left text-right" style="width: 25%;">
                            <div class="" style="padding: 10px;">
                                <p class="m-0"><small>Rp. {{ number_format($price[$item->id]) }},-</small></p>
                            </div>
                        </div>
                    </div>
                    @if(!$loop->last)
            ...
            <div class="clear total-price">
                ...
                <div class="float-left text-right" style="width: 25%;">
                    <div class="" style="padding: 10px;">
                        <p class="m-0"><b>Rp. {{ number_format($total_price) }},-</b></p>
                    </div>
                </div>
            </div>
            ...
            <p class="m-0">Pemesanan telah dikonfirmasi. Segera hubungi <b>{{ $user->name }}</b> untuk melanjutkan proses pemesanan.</p>
            <p class="m-0">Pembayaran akan dilepaskan setelah <b>{{ $user->name }}</b> memberikan konfirmasi penerimaan.</p>
        </div>
