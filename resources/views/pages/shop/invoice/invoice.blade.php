...
<body>
    <div class="invoice">
        ...
        <div class="info-item" style="margin-bottom: 10px;">
                    ...
                    <div class="clear table-content">
                        <div class="float-left" style="width: 40%;">
                            <div class="" style="padding: 10px;">
                                <p class="m-0"><small>{{ $item[$item_id]->name }}</small></p>
                                <p class="m-0"><small>#{{ $item[$item_id]->vendor->name }}</small></p>
                            </div>
                        </div>
                        ...
                        <div class="float-left text-right" style="width: 25%;">
                            <div class="" style="padding: 10px;">
                                <p class="m-0"><small>Rp. {{ number_format(($item[$item_id]->price_after_discount != '' || $item[$item_id]->price_after_discount != null || $item[$item_id]->price_after_discount != 0) ? $item[$item_id]->price_after_discount : $item[$item_id]->normal_price) }},-</small></p>
                            </div>
                        </div>
                        <div class="float-left text-right" style="width: 25%;">
                            <div class="" style="padding: 10px;">
                                <p class="m-0"><small>Rp. {{ number_format($price[$item_id]) }},-</small></p>
                            </div>
                        </div>
                    </div>
                    @if(!$loop->last)
            ...
            <p class="m-0">Pesanan Anda sedang diteruskan, Vendor akan menghubungi Anda untuk proses selanjutnya.</p>
        </div>
