    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-2 col-md-3 col-sm-5 col-5">
                <h6 class="text-white font-weight-bold pull-right">Produk</h6>
                <div class="info text-white mt-xl-5 mt-lg-5 mt-md-4 mt-sm-3">
                    <p><a href="{{ route('simulasi') }}" class="text-white"><small>Simulasi</small></a></p>
                    <p><a href="{{ route('shop') }}" class="text-white"><small>Shop</small></a></p>
                </div>
            </div>

            <div class="col-lg-3 col-md-3 col-sm-7 col-7">
                <h6 class="text-white font-weight-bold">Bantuan</h6>
                <div class="info text-white mt-xl-5 mt-lg-5 mt-md-4 mt-sm-3">
                    <p><a href="{{ route('terms.and.condition') }}" class="text-white"><small>Syarat & Ketentuan</small></a></p>
                    <p><a href="{{ route('privacy.policy') }}" class="text-white"><small>Kebijakan Privasi</small></a></p>
                    <p><a href="{{ route('faq') }}" class="text-white"><small>FAQ</small></a></p>
                </div>
            </div>

            <div class="col-lg-3 col-md-2 col-sm-5 col-5">
                <h6 class="text-white font-weight-bold">Follow Us</h6>
